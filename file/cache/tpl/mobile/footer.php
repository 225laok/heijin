...
"><a href="<?php echo DT_MOB;?>" data-transition="none" data-ajax="false"><span>首页</span></a></li>
<li class="icon-channel<?php if($foot=='channel') { ?>-on<?php } ?>
"><a href="<?php echo DT_MOB;?>channel.php" data-transition="none"><span>频道</span></a></li>
<li class="icon-my<?php if($foot=='my') { ?>-on<?php } ?>
"><a href="<?php echo DT_MOB;?>my.php" data-transition="none"><span>我的</span></a><?php if($_message || $_chat || $_cart) { ?><em></em><?php } ?>
</li>
<li class="icon-more<?php if($foot=='more') { ?>-on<?php } ?>
"><a href="<?php echo DT_MOB;?>more.php" data-transition="none"><span>更多</span></a></li>
</ul>
</div>
<?php } ?>
