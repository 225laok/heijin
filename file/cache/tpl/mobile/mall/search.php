...
<ul>
<li<?php if($v['vip']) { ?> class="vip"<?php } ?>
><a href="<?php echo $v['linkurl'];?>"><strong><?php echo $v['title'];?></strong></a></li>
...
<?php } ?>
<?php if($action != 'ajax') { ?>
<div class="my-cart" onclick="Go('cart.php');"><?php if($_cart) { ?><em><?php echo $_cart;?></em><?php } ?>
</div>
