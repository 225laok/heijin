...
><img src="<?php echo $t['thumb'];?>" width="<?php echo $width;?>" height="<?php echo $height;?>" alt=""/></a>
<ul>
<li><a href="<?php echo $t['linkurl'];?>" title="<?php echo $t['alt'];?>"<?php if($target) { ?> target="<?php echo $target;?>"<?php } ?>
><?php echo $t['title'];?></a></li>
<li><?php if($datetype) { ?><i><?php echo timetodate($t['addtime'], $datetype);?></i><?php } ?>
<em><?php echo $t['items'];?>张图片</em></li>
</ul>
</div>
<?php } } ?>
